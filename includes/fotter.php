<section id="footer" class="section-six">
	<div class="main-div_six">
		<div class="text_one_six">
			<h1>Book My Show: The One-stop Shopping Destination</h1>
			...
			<br>
			<br>
			<h2>What Can You Buy From Book My Show?</h2>
			<h2>Mobile Phones</h2>
